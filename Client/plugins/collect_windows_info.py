...
class Win32Info(object):
    ...
    def get_cpu_info(self):
        ...
        for cpu in cpu_lists:
            cpu_physical_count += cpu.NumberOfCores
            cpu_core_count += cpu.NumberOfLogicalProcessors
        ...
        data['cpu_physical_count'] = cpu_physical_count #CPU物理核数
        tmpdict = {}
        tmpdict["CpuCores"] = 0
