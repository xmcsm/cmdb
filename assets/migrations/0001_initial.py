# Generated by Django 2.2.12 on 2020-06-09 14:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '在运'), (1, '下线'), (2, '未知'), (3, '故障'), (4, '备用')], default=0, verbose_name='设备状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_physical_count', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='CPU物理核数')),
                ('cpu_core_count', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='CPU逻辑核数')),
