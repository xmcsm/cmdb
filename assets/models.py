...
class NewAssetApprovalZone(models.Model):
    ...
    cpu_physical_count = models.PositiveSmallIntegerField('CPU物理核数', blank=True, null=True)
    cpu_core_count = models.PositiveSmallIntegerField('CPU逻辑核数', blank=True, null=True)
    os_distribution = models.CharField('发行商', max_length=64, blank=True, null=True)
